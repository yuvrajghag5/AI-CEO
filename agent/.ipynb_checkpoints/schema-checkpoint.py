...
#     executive_summary: str = Field(min_length=250, description="5-7 sentences: what happened, why it matters, main strategic message")
...
#     ceo_action_plan: List[str] = Field(min_length=3, max_length=3)
