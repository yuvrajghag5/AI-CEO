...
API_KEY =os.getenv("NEWS_API_KEY")    # <-- put your NewsAPI key here
QUERY = '"NVIDIA" AND (earnings OR AI OR chip OR datacenter OR stock OR GPU OR Jensen Huang)'                     # <-- company/keyword to search
