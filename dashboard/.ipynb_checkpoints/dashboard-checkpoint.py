# # RUN :-  python3 -c "from pyngrok import ngrok; ngrok.set_auth_token('3FUuBCmRw6lJJEdI84wwVNohJwZ_7CyVLrEjYbg2bYyqYxsxX')"
...
def render_source_pills(ids):
    if not ids:
        return ""
    return "".join(f'<span class="source-pill">Doc {sid}</span>' for sid in ids)
